...
latex_documents = [
    (master_doc, 'VLNM.tex', 'VLNM Documentation',
     'Mark Wibrow', 'manual'),
]
...
man_pages = [
    (master_doc, 'vlnm', 'VLNM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'VLNM', 'VLNM Documentation',
     author, 'VLNM', 'One line description of project.',
     'Miscellaneous'),
]
